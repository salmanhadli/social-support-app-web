...
const baseInputClasses =
  'w-full p-2 min-h-20 border rounded-md bg-white/5 placeholder-[var(--text-secondary)] focus:border-transparent outline-none transition min-h-10 field-sizing-content'
